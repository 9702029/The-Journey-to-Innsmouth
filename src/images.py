...
testImage = pygame.image.load("images/investigatorOffice.png").convert()
...
image2 = pygame.image.load("images/gamestart.png").convert_alpha()
...
image3 = pygame.image.load("images/Drawing(1).png").convert_alpha()
